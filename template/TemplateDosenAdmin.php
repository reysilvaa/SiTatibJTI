...
class TemplateDosenAdmin extends Template
{
     public function header($username, $koneksi)
     {
          ...
          $query_join = "SELECT u.*, m.nama AS nama_mhs
                    FROM user u
          ...
          echo '
               ...
               <li class="nav-item">
                    <a class="nav-link" href="../../fitur/admin/view_admin.php">
...
$template = new TemplateDosenAdmin();
