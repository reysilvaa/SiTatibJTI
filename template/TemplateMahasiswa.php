...
class TemplateMahasiswa extends Template
{
     ...
     <body>
          ...
          $q = "SELECT m.nama AS nama, u.role AS role
                                   FROM mahasiswa m
                                   JOIN user u ON m.id_user = u.id_user
                                   WHERE m.id_mahasiswa = '$username'";
          ...
          <aside id="sidebar" class="sidebar">
               ...
               <li class="nav-item">
                    <a class="nav-link" href="../../entitas/mahasiswa/home.php">
                    ...
                    <li class="nav-item">
                    <a class="nav-link collapsed" href="../../fitur/sanksi/upload_sanksi.php">
                         <i class="bi bi-person"></i>
                         <span>Upload Sanksi</span>
                    </a>
...
$templateMahasiswa = new TemplateMahasiswa();
